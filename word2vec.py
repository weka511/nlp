...
class GradientDescent:
    ...
    def __init__(self,lr=0.001,decay=0,rg=None,alpha=0.9):
        self.lr = lr
        self.decay = decay
        self.rg = rg
        self.alpha = alpha
...
def create_optimizer(name,
    ...
    match name:
        case 'gradient':
            return GradientDescent(lr=lr,decay=decay,rg=default_rng() if shuffle else None,alpha=alpha)
        case 'stochastic':
            return StochasticGradient(lr=lr,decay=decay,alpha=alpha,n=n)
